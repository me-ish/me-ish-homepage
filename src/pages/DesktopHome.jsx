    ...
    <div className="home">
      ...
      <section id="about" className="about fade-in">
        <div className="about-inner">
          <h2>me-ishとは</h2>
          <p><strong>me-ish（ミーイッシュ）は、すべてのアーティストが自分らしく作品を展示できるオンラインギャラリーです。</strong></p>
          <p>駆け出しの方も、活動歴のある方も、肩書きや実績にとらわれることなく、自分の作品を誰かに届けることができます。</p>
          <p>デジタルアート、NFT、イラスト、現代アート――<br />
          形は違っても、「見てほしい」という想いは同じ。<br />
          me-ishでは、その想いをつなぐ仕組みと場を提供しています。</p>
          <p>展示作品は、購入することもできます。<br />
          NFT販売にも対応しており、円での購入も可能です。</p>
          <p><strong>すべての表現が、自分らしく発信できる場所に。<br />
          me-ishは、アートの可能性を広げるプラットフォームです。</strong></p>
        </div>
      </section>
