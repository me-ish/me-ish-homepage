...
export function LegalNotices({ isNft }: { isNft: boolean }) {
  return (
    <div className="mt-3 text-xs text-gray-500 leading-relaxed space-y-1">
      ...
      {isNft ? (
        <>
          <p>※ 引渡時期：決済後、概ね<strong>72時間以内</strong>にMint・保管、ウォレット登録後<strong>7日以内</strong>に移転（受取猶予<strong>12か月</strong>）。</p>
          <p>※ ガス代は原則当サービス負担（高騰時は移転時期の調整またはご負担の可能性あり）。</p>
        </>
      ) : (
