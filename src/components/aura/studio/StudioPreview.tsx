...
export default function StudioPreview({ form }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {form.displayTitle && (
          <p
            ...
            style={{ color: theme.gradient ? 'rgba(255,255,255,0.85)' : accent }}
          >
            {form.displayTitle}
          </p>
        )}
        {form.tagline && (
          <p
            ...
            style={{ color: theme.gradient ? 'rgba(255,255,255,0.75)' : colors.muted }}
          >
            {form.tagline}
          </p>
        )}
      ...
      {/* Bio */}
      {form.bio && (
        <section className="px-6 py-5" style={{ borderBottom: `1px solid ${colors.border}` }}>
      ...
      {/* Social / Contact */}
      {(form.social.twitter || form.social.instagram || form.social.website) && (
