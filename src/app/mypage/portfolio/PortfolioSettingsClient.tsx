...
export default function PortfolioSettingsClient() {
  ...
  const worksFilter = profile?.works_filter ?? 'displaying';
  const sortKey = profile?.sort_key ?? 'new';
    ...
    <div className="max-w-3xl mx-auto px-4 py-8 space-y-8">
      ...
      <div>
        <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
          <Settings className="h-6 w-6 text-[#00a1e9]" />
          ポートフォリオ設定
        </h1>
        <p className="text-gray-600 mt-1">
          公開用ポートフォリオの表示設定を管理します
        </p>
      </div>
        ...
        <CardContent className="p-6 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <div className="flex-1 overflow-hidden rounded-xl border bg-gray-50 px-3 py-2.5 text-sm text-gray-600">
              ...
              <div className="flex gap-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className={!isPublic ? 'pointer-events-none opacity-50' : ''}
                >
                  <Button
                    type="button"
                    variant="outline"
        ...
        <CardContent className="p-6 space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-gray-500">
              {worksFilter === 'displaying' &&
                '現在ギャラリーに展示中の作品のみ表示されます'}
              {worksFilter === 'for_sale' &&
                '販売設定されている作品のみ表示されます'}
              {worksFilter === 'all' &&
                '承認済みのすべての作品が表示されます'}
            </p>
