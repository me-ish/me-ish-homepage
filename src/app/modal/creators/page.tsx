  ...
  return (
    <main className="px-6 py-16 max-w-3xl mx-auto text-[#222] leading-relaxed">
      ...
      <section className="mb-10">
        <ul className="grid gap-3 sm:grid-cols-4">
          ...
          <li className="rounded-2xl border bg-[#f6f8fb] px-4 py-3">
            ...
            <div className="font-extrabold"><span className="text-[1.4rem] leading-none">15%</span><span className="ml-1 font-semibold">手数料</span></div>
        ...
        <p className="mt-2 text-xs text-[#667]">
          ※ 手数料の内訳・支払い時期は <Link href="/footer/faq#fees" className="underline">FAQ</Link> をご確認ください。
        </p>
      </section>

      {/* 準備するもの */}
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-3 flex items-center gap-2"><ListChecks className="w-5 h-5 text-[#00a1e9]" />準備するもの</h2>
        ...
        <p className="mt-2 text-xs text-[#667]">※ 画像要件の詳細は <Link href="/footer/faq#assets" className="underline">FAQ: 画像ガイド</Link> を参照。</p>
      </section>
      ...
      <section className="mb-12">
        ...
        <ol className="space-y-4">
          <li className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold flex items-center gap-2"><Upload className="w-4 h-4 text-[#00a1e9]" />応募フォームの送信</p>
              <p className="text-sm text-[#555]">作品情報と画像、価格、<strong>出展形式（通常/NFT）</strong>を入力して送信。</p>
            </div>
          </li>
          <li className="flex items-start gap-3">
            <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-[#e7f2ff] text-[#0a5ea8] font-bold">2</span>
            <div>
              <p className="font-semibold flex items-center gap-2"><FileText className="w-4 h-4 text-[#00a1e9]" />運営による内容確認</p>
              <p className="text-sm text-[#555]">公序良俗・権利面のチェック。<Timer className="inline w-3.5 h-3.5" /> 目安：1〜2営業日。</p>
            </div>
          </li>
          <li className="flex items-start gap-3">
            <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-[#e7f2ff] text-[#0a5ea8] font-bold">3</span>
            <div>
              <p className="font-semibold flex items-center gap-2"><ShieldCheck className="w-4 h-4 text-[#00a1e9]" />画像の保護処理</p>
              <p className="text-sm text-[#555]">ウォーターマーク／署名、AI学習阻害（例：Glaze）等を適用。</p>
            </div>
          </li>
          <li className="flex items-start gap-3">
            <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-[#e7f2ff] text-[#0a5ea8] font-bold">4</span>
            <div>
              <p className="font-semibold flex items-center gap-2"><Img className="w-4 h-4 text-[#00a1e9]" />展示・販売スタート</p>
              <p className="text-sm text-[#555]">ギャラリーに掲出。SOLD／エディション情報は自動表示。</p>
            </div>
          </li>
          <li className="flex items-start gap-3">
            <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-[#e7f2ff] text-[#0a5ea8] font-bold">5</span>
            <div>
              <p className="font-semibold flex items-center gap-2"><CreditCard className="w-4 h-4 text-[#00a1e9]" />決済・NFT発行/受け渡し</p>
              <p className="text-sm text-[#555]">
                支払いはクレジット（円）。<strong>NFT出展を選んだ作品のみ</strong>、購入後に当ギャラリーがNFTを発行し、購入者へ受け渡します。
              </p>
            </div>
          </li>
        </ol>
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc ml-5 space-y-1 text-[0.97rem]">
          <li>出展作品にはウォーターマーク／署名とAI学習阻害処理を適用します。</li>
          <li>オリジナル性、公序良俗、権利クリアを確認します。</li>
          <li><strong>AI生成のみの作品は不可</strong>。人手による創作が含まれること。</li>
          <li>展示の最適化のため、軽微なリサイズ・圧縮を行う場合があります。</li>
        </ul>
        <p className="mt-2 text-xs text-[#667]">詳細は <Link href="/footer/faq#policy" className="underline">出展ポリシー</Link> をご確認ください。</p>
      </section>

      {/* Q：NFT出展について（補足） */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-3 flex items-center gap-2"><BadgeCheck className="w-5 h-5 text-[#00a1e9]" />NFT出展の補足</h2>
        <ul className="list-disc ml-5 space-y-1 text-[0.97rem]">
          <li>決済はクレジット（円）のみ。暗号資産での購入は不可。</li>
          <li>NFTの発行はme-ish側で実施。購入後に購入者へ移転（受け取り用ウォレットが必要）。</li>
          <li>作者はウォレット不要（希望があれば作者受取も可）。</li>
        </ul>
      </section>
