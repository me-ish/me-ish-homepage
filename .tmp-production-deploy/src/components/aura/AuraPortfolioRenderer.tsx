...
import { VARIANTS, type VariantSpec } from "@/lib/aura/aura.variant.base";
import { fontFamilyFromPreset } from "@/styles/auraFonts";
import type { LayoutPref, SectionType, LayoutType } from "@/lib/aura/aura.layout";
import { SPACING, TYPOGRAPHY, TRANSITION } from "@/lib/aura/aura.designSystem";
...
import { AuraHeroSwitcher } from "./sections/AuraHeroSwitcher";

/* 既存セクション */
import { AuraAboutSimple } from "./sections/AuraAboutSimple";
import { AuraGalleryGrid } from "./sections/AuraGalleryGrid";
import { AuraServices } from "./sections/AuraServices";
import { AuraSkills } from "./sections/AuraSkills";
import { AuraContact } from "./sections/AuraContact";
 ...
 * MAIN RENDERER
 * --------------------------------------------------------- */
export default function AuraPortfolioRenderer({
  design,
  content,
...
<section key={type} id={id} className={sectionWrapperClass}>
  <AuraHeroSwitcher section={data} theme={theme} variant={renderVariant} />
</section>
              );
            ...
            case "about":
              return (
                <section key={type} id={id} className={sectionWrapperClass}>
                  <AuraAboutSimple section={data} theme={theme} variant={renderVariant} />
                </section>
              );
            ...
            case "works":
              return (
                <section key={type} id={id} className={sectionWrapperClass}>
                  <AuraGalleryGrid section={data} theme={theme} variant={renderVariant} />
                </section>
              );
            ...
            case "services":
              return (
                <section key={type} id={id} className={sectionWrapperClass}>
                  <AuraServices section={data} theme={theme} variant={renderVariant} />
                </section>
              );
            ...
            case "skills":
              return (
                <section key={type} id={id} className={sectionWrapperClass}>
                  <AuraSkills section={data} theme={theme} variant={renderVariant} />
                </section>
              );
            ...
            case "contact":
              return (
                <section key={type} id={id} className={sectionWrapperClass}>
                  <AuraContact section={data} theme={theme} variant={renderVariant} />
                </section>
              );
